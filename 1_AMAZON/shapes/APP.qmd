...
<qgis version="3.22.4-Bia?owie?a">
  <identifier>app_CalculateAreas</identifier>
  <parentidentifier></parentidentifier>
  <language>PT</language>
  <type>dataset</type>
  <title>app_CalculateAreas</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Shapefile" url="file://\\SILVANA-PC\Users\Silvana\Documents\Silvana\AbunaOld\app_CalculateAreas.shp" size="" type="Local Area Network" mimeType="" description="" format=""/>
  </links>
  <fees></fees>
