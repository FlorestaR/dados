...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Shapefile" url="file://\\LMQ-MELALEUCA\C$\Documents and Settings\jlpolize\Meus documentos\Downloads\shapefiles\alines.shp" size="" type="Local Area Network" mimeType="" description="" format=""/>
  </links>
  <fees></fees>
