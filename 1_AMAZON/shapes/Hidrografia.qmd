...
<qgis version="3.22.4-Bia?owie?a">
  <identifier>hidrografia_SmoothLine</identifier>
  <parentidentifier></parentidentifier>
  <language>PT</language>
  <type>dataset</type>
  <title>hidrografia_SmoothLine</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Shapefile" url="file://\\LMQ-MAGNOLIA\C$\Documents and Settings\jlpolize.FLORESTA\Meus documentos\POA-SILVANA\POA\ArcGis\hidrografia_SmoothLine.shp" size="" type="Local Area Network" mimeType="" description="" format=""/>
  </links>
  <fees></fees>
